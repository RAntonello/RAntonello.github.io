tinymce.init({
    ...
    file_browser_callback: function(field_name, url, type, win) { 
        tinyMCE.activeEditor.windowManager.open({
            file           : 'http://www.itcs-conf.org/dadamail/dada_mail_support_files/kcfinder/browse.php?opener=tinymce&type=' + type,
            title          : 'KCFinder',
            width          : 700,
            height         : 500,
            resizable      : "yes",
    ...
    protect: [
     ...
     document_base_url :     "http://www.itcs-conf.org/dadamail/dada_mail_support_files/",
